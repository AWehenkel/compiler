...
; Function Attrs: nounwind ssp uwtable
define void @printBool(i16 signext) #0 {
...
define void @print(i8*) #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0), i8* %3)
  ret void
}

; Function Attrs: nounwind ssp uwtable
define i32 @inputInt32() #0 {
...
; Function Attrs: nounwind ssp uwtable
define signext i16 @inputBool() #0 {
  %1 = alloca i16, align 2
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i16* %1)
  %3 = load i16, i16* %1, align 2
  ret i16 %3
}

; Function Attrs: nounwind ssp uwtable
define i8* @inputLine() #0 {
  %1 = alloca i8*, align 8
  %2 = call i8* @malloc(i64 10000)
