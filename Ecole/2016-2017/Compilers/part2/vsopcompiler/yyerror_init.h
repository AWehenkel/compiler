...
{
   errtab[73].i = 2;
   errtab[73].u.p = (errtable*) calloc(1,3 * sizeof(struct errtable));
   ...
   errtab[141].i = 4;
   errtab[141].u.p = (errtable*) calloc(1,5 * sizeof(struct errtable));
   ...
   errtab[125].i = 2;
   errtab[125].u.p = (errtable*) calloc(1,3 * sizeof(struct errtable));
   ...
   errtab[66].i = 6;
   errtab[66].u.p = (errtable*) calloc(1,7 * sizeof(struct errtable));
   ...
   errtab[144].i = 2;
   errtab[144].u.p = (errtable*) calloc(1,3 * sizeof(struct errtable));
   ...
   errtab[102].i = 13;
   errtab[102].u.p = (errtable*) calloc(1,14 * sizeof(struct errtable));
   ...
   errtab[75].i = 5;
   errtab[75].u.p = (errtable*) calloc(1,6 * sizeof(struct errtable));
   ...
   errtab[127].i = 2;
   errtab[127].u.p = (errtable*) calloc(1,3 * sizeof(struct errtable));
   ...
   errtab[148].i = 2;
   errtab[148].u.p = (errtable*) calloc(1,3 * sizeof(struct errtable));
   ...
   errtab[90].i = 2;
   errtab[90].u.p = (errtable*) calloc(1,3 * sizeof(struct errtable));
   ...
   errtab[6].i = 3;
   errtab[6].u.p = (errtable*) calloc(1,4 * sizeof(struct errtable));
   ...
   errtab[69].i = 2;
   errtab[69].u.p = (errtable*) calloc(1,3 * sizeof(struct errtable));
   ...
   errtab[84].i = 2;
   errtab[84].u.p = (errtable*) calloc(1,3 * sizeof(struct errtable));
